...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Bmi = field.NewInt32(tableName, "bmi")
	_user.MobilityValue = field.NewString(tableName, "mobility_value")
	_user.AvailableTimeValues = field.NewString(tableName, "available_Time_values")
	_user.Latitude = field.NewFloat64(tableName, "latitude")
	_user.Longitude = field.NewFloat64(tableName, "longitude")
...
type user struct {
	...
	Age                 field.Int32   // 年龄
	Bmi                 field.Int32   // BMI
	MobilityValue       field.String  // MobilityValue
	AvailableTimeValues field.String  // AvailableTimeValues
	Latitude            field.Float64 // latitude
	Longitude           field.Float64 // Longitude
...
func (u *user) updateTableName(table string) *user {
	...
	u.Bmi = field.NewInt32(table, "bmi")
	u.MobilityValue = field.NewString(table, "mobility_value")
	u.AvailableTimeValues = field.NewString(table, "available_Time_values")
	u.Latitude = field.NewFloat64(table, "latitude")
	u.Longitude = field.NewFloat64(table, "longitude")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["bmi"] = u.Bmi
	u.fieldMap["mobility_value"] = u.MobilityValue
	u.fieldMap["available_Time_values"] = u.AvailableTimeValues
